<html>
    ...
    <body>
        ...
        <div id="image">
             <img src="../images/TomatoSoup.png" alt="">
        </div>

        <br><h2>Ingredients:</h2>
        <ul><li>1/2 lb butter</li><li>1 lb diced onions</li><li>6 lb diced tomatoes</li></ul>
        <br><h2>Instructions:</h2>
        <ol><li>1. Place a pot over medium heat and melt the butter, add onion and tomatoes.</li><li>2. Bring to a low simmer, add some salt and leave and cook for about 40 minutes.</li><li>3. Blend and serve.</li></ol>
<?php
